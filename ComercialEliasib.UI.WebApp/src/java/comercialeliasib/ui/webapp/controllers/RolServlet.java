...
import comercialeliasib.accesoadatos.RolDAL;
import comercialeliasib.entidadesdenegocio.Rol;
import comercialeliasib.ui.webapp.utils.*;
...
public class RolServlet extends HttpServlet {private Rol obtenerRol(HttpServletRequest request) {
    ...
    private void requestObtenerPorId(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (rol_result.getId() > 0) {
                ...
                Utilidad.enviarError("El Id:" + rol_result.getId()
